...
public class overState{
  ...
  public overState(){
    ...
    backGround.setIcon(new ImageIcon ("Resources/Background/overback.jpg"));

    Color c1 = new Color(254,76,74);
    play.setLocation ( 151, 500 );
    play.setSize (200,100);
    play.setBackground (c1);
    play.setIcon(new ImageIcon ("Resources/Picbutton/play.png"));

    Color c2 = new Color(64,19,13);
  ...
  public void playMusic() {
      try {
        ...
        URL url = this.getClass().getClassLoader().getResource("Resources/Music/sadly.wav");
